...
![Example rollout results](results/hoolt_fixed_omega.png)

As can be seen the model generalizes nicely in this case. 

# Learning $\omega$ 

We can also try to train the model using variable $\omega$ and hope that the model learns this parameter as part of training. This is still a work in progress. 