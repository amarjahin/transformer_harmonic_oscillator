...
![Example rollout results with $\omega_0 = 2$, and $\gamma = 0$](results/hoolt_fixed_omega.png)

![Example rollout results with $\omega_0 = 2$, and $\gamma = 0.1$](results/hoolt_fixed_omega_gamma.png)

As can be seen the model generalizes nicely in this case. 

# Learning $\omega_0$ and $\gamma$
